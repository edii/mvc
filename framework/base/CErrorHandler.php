...
class CErrorHandler extends \CApplicationComponent
{
	 ...
	 * Inside the action, it can retrieve the error information by \init::app()->errorHandler->error.
	...
	protected function handleException($exception)
	{
		...
		if($app instanceof \CWebApplication)
		{
			...
			if($exception instanceof \CHttpException || !DEBUG)
	...
	protected function render($view,$data)
	{
		...
		if($view==='error' && $this->errorAction!==null)
			\init::app()->runController($this->errorAction);
		else
		{
	...
	protected function getVersionInfo()
	{
		if(DEBUG)
		{
			$version='<a href="http://www.initframework.com/">init Framework</a>/'.\init::getVersion();
