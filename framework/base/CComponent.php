...
class CComponent
{
	...
	{            
		...
		throw new \CException(\init::t('init','{class} and its behaviors do not have a method or closure named "{name}".',
	 ...
	 * parameter to {@link Base::createComponent} to create the behavior object.
				...
				elseif(is_callable($handler,true))
				{
					if(is_array($handler))
					{
						...
						elseif(method_exists($object,$method))
							...
							throw new CException(init::t('init','Event "{class}.{event}" is attached with an invalid handler "{handler}".',
